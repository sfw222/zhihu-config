...
(function () {
    ...
    if (current === 'dark') {
        ...
        s.textContent = `
            ...
            html[data-theme="dark"] .ContentItem-actions{color:var(--GBK05A,#888d96)!important}
            ...
            html[data-theme="dark"] .ContentItem-actions .ContentItem-action:hover{color:var(--GBK02A,#fff)!important}
        `;
